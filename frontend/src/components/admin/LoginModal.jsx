...
function Particles() {
  useEffect(() => {
    const createParticle = () => {
      ...
      particle.className =
        "absolute w-2 h-2 bg-gradient-to-br from-sky-400 to-purple-400 rounded-full";
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <p className="text-slate-400 text-center">
                      Access your dashboard to manage users, quizzes, and view
                      analytics.
                    </p>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="p-3 rounded-lg bg-slate-900/30 border border-slate-700/30">
                    <p className="text-sm text-slate-300">
                      email: <span className="text-sky-400">ad@gmail.com</span>
                    </p>
                    <p className="text-sm text-slate-300">
                      Password: <span className="text-sky-400">admin</span>
                    </p>
                  </div>
                </motion.div>
              </Dialog.Panel>
